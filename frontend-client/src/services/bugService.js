...
async function getBugsByBoardId(boardId) {
  ...
  const mockData = [
    { id: 'bug1', title: 'Bug 1', description: 'Description for Bug 1', label: '30 mins' },
    { id: 'bug2', title: 'Bug 2', description: 'Description for Bug 2', label: '45 mins' },
    { id: 'bug2', title: 'Arreglar kanban board', description: 'Está todo roto', label: '45 mins' },
...
export { getBugsByBoardId, getBugById };
